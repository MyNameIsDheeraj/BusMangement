# Updated API Endpoint Documentation - Bus Management System

This document provides comprehensive documentation for all API endpoints in the Bus Management System after restricting registration to admin users only, including authentication, authorization, request/response formats, and testing procedures.
...
### 68. Create Teacher (via Admin Registration)
- **Method:** `POST`
- **URL:** `/api/v1/register`
- **Authentication:** JWT Bearer token required (Admin role)
- **Description:** Create a new teacher account through admin registration
- **Headers:** `Authorization: Bearer <admin_token>`
- **Request Body:**
```json
{
...
### 75. Create Parent (via Admin Registration)
- **Method:** `POST`
- **URL:** `/api/v1/register`
- **Authentication:** JWT Bearer token required (Admin role)
- **Description:** Create a new parent account through admin registration
- **Headers:** `Authorization: Bearer <admin_token>`
- **Request Body:**
```json
{
